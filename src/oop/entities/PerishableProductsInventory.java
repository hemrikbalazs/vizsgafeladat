 ...
 */
public class PerishableProductsInventory implements EventBroadcaster{
    
    private ProductList products;
    private List<EventListener> listeners;

    public PerishableProductsInventory() {
        try {
            products = StorageInventoryFactory.createPerishableProductsInventory();
